...
uint8_t global_notif_val_tab[248]; /* was 64: 240-byte REC_CHUNK notify payload
                                      overflowed here, corrupting bytes past 64
                                      (memcpy below copies sizeof=this) */
uint8_t global_notif_val_tab_len = 0;
uint8_t global_indic_serv_index = 0;
uint8_t global_indic_char_index = 0;
uint8_t global_indic_val_tab[248]; /* was 64: match notify */
