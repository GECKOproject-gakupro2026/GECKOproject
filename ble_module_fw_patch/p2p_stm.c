...
void P2PS_STM_Init(void)
{
  ...
  SVCCTL_RegisterSvcHandler(PeerToPeer_Event_Handler);
    ...
    aci_gatt_add_char(aPeerToPeerContext.PeerToPeerSvcHdle,
                      UUID_TYPE_128, &uuid16,
                      20, /* was 2: carry full 20-byte telemetry frames */
                      CHAR_PROP_NOTIFY,
                      ATTR_PERMISSION_NONE,
                      GATT_NOTIFY_ATTRIBUTE_WRITE, /* gattEvtMask */
                      10, /* encryKeySize */
...
/**
 * @brief  Notify an arbitrary payload on the P2P notify characteristic
 *         (the stock update API hardcodes a 2-byte button payload)
 */
tBleStatus P2PS_STM_Notify_Raw(uint8_t *pPayload, uint8_t Length)
{
  return aci_gatt_update_char_value(aPeerToPeerContext.PeerToPeerSvcHdle,
                                    aPeerToPeerContext.P2PNotifyServerToClientCharHdle,
                                    0, /* charValOffset */
                                    Length,
                                    pPayload);
