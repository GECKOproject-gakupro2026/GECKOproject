/**
  ...
  * @brief   This file includes a standard driver for the MX25LM51245G Octal
  *          NOR OSPI memory mounted on the B_U585I_IOT02A board. The APS6408
  *          Octal PSRAM half of this driver was removed (unused by the
  *          application; ota.cpp only uses the NOR functions below).
  ******************************************************************************
  * @attention
  *
  ...
  ******************************************************************************
  ...
  [..]
   (#) This driver is used to drive the MX25LM51245G Octal NOR external memory
       mounted on B_U585I_IOT02A board.

   (#) This driver needs the MX25LM51245G component driver to be included with.
...
/* Shared by both NOR (Instance param) and RAM (hospi_ram) init paths */
