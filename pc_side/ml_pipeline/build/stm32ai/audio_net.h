/**
  ...
  ******************************************************************************
  */
#ifndef AI_AUDIO_NET_H
#define AI_AUDIO_NET_H

#include "audio_net_config.h"
...
#define AI_AUDIO_NET_INPUTS_IN_ACTIVATIONS   (4)
#define AI_AUDIO_NET_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_AUDIO_NET_IN_NUM        (1)

AI_DEPRECATED
#define AI_AUDIO_NET_IN \
  ai_audio_net_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_AUDIO_NET_IN_SIZE { \
  AI_AUDIO_NET_IN_1_SIZE, \
}
...
AI_DEPRECATED
#define AI_AUDIO_NET_OUT \
  ai_audio_net_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_AUDIO_NET_OUT_SIZE { \
  AI_AUDIO_NET_OUT_1_SIZE, \
}
#define AI_AUDIO_NET_OUT_SIZE_BYTES { \
 ...
 * @ref ai_audio_net_create. Both the activations memory buffer 
 ...
 * using @ref ai_audio_net_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_audio_net_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_audio_net_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_AUDIO_NET_*
 * defines into file @ref audio_net.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_audio_net_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_AUDIO_NET_H */
